exports.yargs = {
    ...
    handler: async(argv) => {
        const { write, requestMethod, nameDictionary, extensionDictionary, namePrefix, nameSuffix, extensionPrefix, extensionSuffix, requestConcurrency, loadConcurrency, header, timeout, all, yes, blessed, url } = argv
