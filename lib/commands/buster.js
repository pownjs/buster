exports.yargs = {
    ...
    handler: async(argv) => {
        const { requestMethod, nameDictionary, extensionDictionary, namePrefix, nameSuffix, extensionPrefix, extensionSuffix, requestConcurrency, loadConcurrency, yes, url } = argv
        ...
        const req = { method: requestMethod, uri: url }
