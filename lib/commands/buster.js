exports.yargs = {
    ...
    handler: async(argv) => {
        const { requestMethod, nameDictionary, extensionDictionary, namePrefix, nameSuffix, extensionPrefix, extensionSuffix, requestConcurrency, loadConcurrency, header, timeout, yes, url } = argv
