exports.yargs = {
    ...
    handler: async(argv) => {
        const { requestMethod, nameDictionary, extensionDictionary, namePrefix, nameSuffix, extensionPrefix, extensionSuffix, requestConcurrency, loadConcurrency, timeout, yes, url } = argv
        ...
        const req = { method: requestMethod, uri: url, timeout }
